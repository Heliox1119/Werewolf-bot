...
(function() {
  ...
  const translations = {
    fr: {
      ...
      'premium.subtitle': 'Débloquez des fonctionnalités exclusives et améliorez votre expérience. Bientôt disponible !',
      'premium.feature_themes': 'Thèmes personnalisés',
      'premium.feature_themes_desc': 'Accédez à des thèmes exclusifs et des couleurs d\'embed personnalisées.',
      'premium.feature_roles': 'Rôles exclusifs',
      'premium.feature_roles_desc': 'Débloquez des rôles premium comme le Renard, le Forgeron et plus.',
      'premium.feature_stats': 'Stats avancées',
      'premium.feature_stats_desc': 'Analyses détaillées, classements avancés et graphiques d\'historique.',
      'premium.feature_priority': 'Support prioritaire',
      'premium.feature_priority_desc': 'Accès prioritaire à l\'aide, corrections de bugs et demandes de fonctionnalités.',
      'premium.feature_sounds': 'Effets sonores',
      'premium.feature_sounds_desc': 'Sons personnalisés pour les transitions, les morts et les victoires.',
      'premium.feature_badges': 'Badge Premium',
      'premium.feature_badges_desc': 'Affichez votre statut premium avec un badge exclusif.',
      'premium.coming_soon': 'Bientôt disponible',
      'premium.coming_soon_desc': 'Les fonctionnalités premium sont en cours de développement. Restez à l\'écoute !',
    ...
    en: {
      ...
      'grules.min_players': 'Minimum players',
      'grules.max_players': 'Maximum players',
      'grules.min_hint': 'Between 3 and 6',
      'grules.max_hint': 'Between min and 20',
      'grules.win_title': 'Win Condition',
